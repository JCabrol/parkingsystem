...
public class TicketDAO {
    ...
    public boolean saveTicket(Ticket ticket){
        ...
        try {
            ...
            //ID, PARKING_NUMBER, VEHICLE_REG_NUMBER, PRICE, IN_TIME, OUT_TIME, REDUCTION_RATE)
            ...
            ps.setDouble(6,ticket.getReductionRate());
            return ps.execute();
        }catch (Exception ex){
    ...
    public Ticket getTicket(String vehicleRegNumber) {
        ...
        try {
            ...
            if(rs.next()){
                ...
                ticket.setReductionRate(rs.getDouble(7));
            }
